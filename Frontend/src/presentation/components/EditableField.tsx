    ...
    <div className="relative">
      {isEditing ? (
        <div className="space-y-3">
          ...
          {/* Textarea with better mobile spacing */}
          <textarea
            value={editedValue}
            onChange={(e) => setEditedValue(e.target.value)}
            className="w-full bg-[#282c34] text-gray-200 rounded-xl p-4 
                     border border-gray-800/50 
                     focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/30 
                     transition-all duration-200 min-h-[100px] text-sm
          ...
          <div className="flex w-full gap-3 mt-3">
            <button
              ...
              className="flex-1 py-3 text-sm bg-[#282c34] text-gray-300
            ...
            <button
              onClick={handleSave}
              className="flex-1 py-3 text-sm bg-blue-500/10 text-blue-400
        ...
        <div className="group">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="p-2 bg-gray-800/50 hover:bg-gray-700/50 
          ...
          {/* Content area with better touch target */}
          <div 
            onClick={() => setIsEditing(true)}
            className="bg-[#282c34] rounded-xl p-4 min-h-[60px]
